    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3 text-xs">
        <div className="bg-[#0F1113] border border-white/10 p-3">
          ...
          <span className="block text-white/60 text-xs mt-2">{measuredDrivewayPoints.length} map points</span>
        </div>
        ...
        <div className="bg-[#0F1113] border border-white/10 p-3">
          ...
          <span className="block text-white/60 text-xs mt-2">{measuredFrontPatioPoints.length} map points</span>
        </div>
        ...
        <div className="bg-[#0F1113] border border-white/10 p-3">
          ...
          <span className="block text-white/60 text-xs mt-2">{measuredBackPatioPoints.length} map points</span>
        </div>
      </div>
    </div>
  );
